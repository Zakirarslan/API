...
public class Get09 extends HerokuAppBaseUrl {
  /*
    ...
    public void get09() {
        ...
        Response response = RestAssured.given(spec).when().get("{p1}/{p2}");
        ...
        Assert.assertEquals(bookingMap.get("checkin"), ((Map) (actualData.get("bookingdates"))).get("checkin"));
        Assert.assertEquals(bookingMap.get("checkout"), ((Map) actualData.get("bookingdates")).get("checkout"));
